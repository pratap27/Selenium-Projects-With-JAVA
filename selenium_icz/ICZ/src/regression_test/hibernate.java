...
public class hibernate {
	...
	public void c(){
		...
		d.findElement(By.xpath(".//*[@id='wrapper']/div/ul/li[7]/a")).click();
		
		WebElement c1 = d.findElement(By.xpath(".//*[@id='wrapper']/div[2]/div/b/ul"));
		...
		for(int i=0; i<links.size(); i++){
			...
			d.navigate().back();
			c1 =  d.findElement(By.xpath(".//*[@id='wrapper']/div[2]/div/b/ul"));
